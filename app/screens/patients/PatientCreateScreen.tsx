...
import { Save, X, ArrowLeft, User, Mail } from 'lucide-react-native';
    ...
    <SafeAreaView style={globalStyles.container}>
      <View style={globalStyles.header}>
        ...
        <View style={{ flex: 1, marginLeft: 12 }}>
          ...
          <Text style={globalStyles.headerSubtitle}>Registrar paciente</Text>
        </View>
      </View>
      ...
      <ScrollView style={globalStyles.content}>
        <View style={globalStyles.card}>
          ...
          <View style={globalStyles.inputContainer}>
            ...
            <View style={globalStyles.inputWithIcon}>
              <Mail color={colors.text.secondary} size={20} style={globalStyles.inputIcon} />
              <TextInput
                style={globalStyles.textInput}
