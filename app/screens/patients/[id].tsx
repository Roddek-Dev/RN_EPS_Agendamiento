...
import { User, Phone, Mail, Calendar, Edit, Clock, ArrowLeft } from "lucide-react-native"
...
export default function PatientDetailScreen() {
  ...
  const DetailRow = ({ icon: Icon, label, value }: { icon: any; label: string; value: string }) => (
    <View style={globalStyles.detailRow}>
      <Icon color={colors.text.secondary} size={20} style={globalStyles.detailIcon} />
      <View>
  ...
  return (
    <SafeAreaView style={globalStyles.container}>
      <View style={globalStyles.header}>
        ...
        <TouchableOpacity style={[globalStyles.iconButton, { backgroundColor: colors.primary }]} onPress={editPatient}>
      ...
      <ScrollView contentContainerStyle={globalStyles.content}>
        <View style={globalStyles.profileSection}>
          <Image source={{ uri: patient.avatar }} style={globalStyles.profileAvatar} />
        ...
        <View style={globalStyles.card}>
          ...
          <DetailRow icon={Calendar} label="Fecha de Nacimiento" value={patient.birthDate} />
        </View>

        <View style={globalStyles.card}>
          <Text style={globalStyles.sectionTitle}>Historial Reciente</Text>
          <DetailRow icon={Clock} label="Última cita" value={patient.lastAppointment} />
          <DetailRow icon={Clock} label="Total de citas" value={patient.totalAppointments.toString()} />
        </View>
        ...
        <View style={globalStyles.card}>
          ...
          <View style={globalStyles.metadataCard}>
            <View style={globalStyles.metadataItem}>
              ...
              <Text style={globalStyles.metadataValue}>{patient.createdAt}</Text>
            </View>
            <View style={globalStyles.metadataItem}>
              <Text style={globalStyles.metadataLabel}>Última Actualización:</Text>
              <Text style={globalStyles.metadataValue}>{patient.updatedAt}</Text>
            </View>
          </View>
        </View>
      </ScrollView>
