    ...
    <View style={globalStyles.listCard}>
      ...
      <View style={{ flex: 1, marginLeft: 12 }}>
        ...
        >
          ...
          <StatusBadge status={specialty.status} customText={specialty.status === "active" ? "Activa" : "Inactiva"} />
        </View>
        ...
        <View style={{ gap: 4, marginBottom: 8 }}>
          ...
          <View style={[globalStyles.row, { alignItems: "center", gap: 6, marginTop: 4 }]}>
            ...
            <Text style={[globalStyles.itemTitle, { fontSize: 16, color: colors.primary }]}>
              {specialty.doctors} doctor{specialty.doctors !== 1 ? "es" : ""} disponible
              {specialty.doctors !== 1 ? "s" : ""}
            </Text>
          </View>
        </View>
      </View>
