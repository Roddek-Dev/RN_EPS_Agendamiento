...
import { Heart, FileText, Users, BarChart2, Calendar, Activity } from "lucide-react-native"
...
export default function SpecialtyDetailScreen() {
  ...
  const specialty = {
    ...
    services: ["Electrocardiograma", "Ecocardiograma", "Prueba de esfuerzo", "Holter", "Consulta cardiológica"],
    appointments: {
      total: 45,
      thisMonth: 12,
      pending: 3,
  ...
  return (
    <SafeAreaView style={globalStyles.container}>
      <ProfileHeader
        ...
        onBack={() => router.back()}
        onEdit={() => router.push(`/(main)/cruds/specialties/edit/${id}`)}
      />
