...
import { User, UserCheck, Calendar, Clock, ClipboardList, MessageSquare, FileText } from "lucide-react-native"
  ...
  return (
    <SafeAreaView style={globalStyles.container}>
      <ProfileHeader
        ...
        onBack={() => router.back()}
        onEdit={() => router.push(`/(main)/cruds/appointments/edit/${id}`)}
      />
      ...
      <ScrollView contentContainerStyle={globalStyles.content}>
        ...
        <View style={globalStyles.card}>
          ...
          <DetailRow icon={Calendar} label="Fecha" value={appointment.date} color={colors.primary} />
          <DetailRow icon={Clock} label="Hora" value={appointment.time} />
          <DetailRow icon={ClipboardList} label="Tipo de Cita" value={appointment.type} />
        </View>

        <View style={globalStyles.card}>
          <Text style={globalStyles.sectionTitle}>Participantes</Text>
          <DetailRow icon={User} label="Paciente" value={appointment.patient} />
          <DetailRow icon={UserCheck} label="Doctor" value={appointment.doctor} />
        </View>

        <View style={globalStyles.card}>
          <Text style={globalStyles.sectionTitle}>Detalles de la Consulta</Text>
          <DetailRow icon={MessageSquare} label="Motivo de la Consulta" value={appointment.reason} />
          <DetailRow icon={FileText} label="Notas Adicionales" value={appointment.notes} />
        </View>
      </ScrollView>
    </SafeAreaView>
  )
